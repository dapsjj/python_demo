...
# load the dataset
dataframe = pd.read_csv(r'E:/test_opencv/his.csv', usecols=[1])
plt.plot(dataframe)
...
pd.DataFrame(testY_inverse).to_csv(r'./his_result.csv', index=False, mode='w', header=True, encoding='utf-8-sig')
