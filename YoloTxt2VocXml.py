...
## coco classes
YOLO_CLASSES = ('FastFoodBox', 'FouledPlastic', 'CigaretteButts', 'FruitPeel', 'FruitPulp', 'Cardboard',
               'Eggshell', 'RingPullCan', 'DrinkBottle', 'Leaf', 'Paper', 'GlassBottle', 'Stone')
...
## path root folder
ROOT = r'C:/Users/Administrator/Desktop/13garbage'
